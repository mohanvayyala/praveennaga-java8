package com.praveennaga.java8.streams;
...
public class StreamExample {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				fruitList.stream().flatMap(s -> s.chars().mapToObj(i -> (char) i)).collect(Collectors.toList()));
		// [b, a, n, a, n, a, a, p, p, l, e, m, a, n, g, o, g, r, a, p, e, s]

		System.out.println(fruitList.stream().map(String::toUpperCase).collect(Collectors.toList())); // [BANANA, APPLE,
																										// MANGO,
																										// GRAPES]
		System.out.println(fruitList.stream().mapToInt(String::length).boxed().collect(Collectors.toList())); // [6, 5,
																												// 5, 6]
		...
		System.out.println(
				numList.stream().mapToInt(num -> num * 5).collect(ArrayList::new, ArrayList::add, ArrayList::addAll)); // [5,
																														// 45,
																														// 40,
																														// 25]
		System.out.println(numList.stream().mapToInt(num -> num * 5).boxed().collect(Collectors.toList())); // [5, 45,
																											// 40, 25]
		...
		System.out.println(eList.stream().collect(Collectors.groupingBy(Employee1::getEmpName)));
		System.out.println(eList.stream().collect(Collectors.groupingBy(Employee1::getEmpName,
		...
		Stream.of("java", "c", "c#", "python").reduce((x, y) -> x + " | " + y).ifPresent(System.out::println); // java |
																												// c |
																												// c# |
																												// python
		...
		System.out.println(Stream.of("java", "c", "c#", "python").reduce("Languages:", (x, y) -> x + " | " + y)); // Languages:
																													// |
																													// java
																													// |
																													// c
		...
		System.out.println(arrSum);/*
									 * combiner called combiner called combiner called combiner called 5078
									 */
